...
const Sidee = () => {
  ...
  <aside class="sidebar">
    ...
    <nav class="sidebar-nav">
      <ul>
        <li>
          <a href="#"><i class="ion-bag"></i> <span>POSTPAYÉS</span></a>
          <ul class="nav-flyout">
            <li>
              <a href="#"><i class="ion-ios-color-filter-outline"></i>Sama Libre</a>
            </li>
           
            <li>
              <a href="#"><i class="ion-android-star-outline"></i>BeKING</a>
            </li>
            <li>
              <a href="#"><i class="ion-heart-broken"></i>WIN Max Libre</a>
            </li>
          </ul>
        </li>
        <li>
