...
var _excluded2 = ["onEnter", "onEntering", "onEntered", "onExit", "onExiting", "onExited", "addEndListener", "children"];
...
var PopoverHeader = React4.forwardRef(({
  className,
  bsPrefix,
  as: Component = "div",
  ...props
...
var PopoverBody = React5.forwardRef(({
  className,
  bsPrefix,
  as: Component = "div",
  ...props
...
var Popover = React6.forwardRef(({
  ...
  return (0, import_jsx_runtime6.jsxs)("div", {
    ...
    children: [(0, import_jsx_runtime5.jsx)("div", {
      ...
      ...arrowProps
    }), body ? (0, import_jsx_runtime5.jsx)(PopoverBody_default, {
      children
    }) : children]
  });
});
...
function useOverlayOffset(customOffset) {
  ...
  const offset2 = (0, import_react11.useMemo)(() => ({
    name: "offset",
    options: {
      offset: () => {
        if (customOffset) {
...
var Overlay2 = React8.forwardRef(({
  children: overlay,
  ...
  return (0, import_jsx_runtime8.jsx)(Overlay_default, {
    ...outerProps,
    ref: mergedRef,
    popperConfig: {
      ...popperConfig,
    ...
    children: (overlayProps, {
      ...
      return React8.cloneElement(overlay, {
        ...overlayProps,
        placement: updatedPlacement,
        arrowProps,
        popper: popper2,
...
var OverlayTrigger = ({
  ...
  const {
    ...
    onBlur,
    onClick
  } = typeof children !== "function" ? React9.Children.only(children).props : {};
  const attachRef = (r) => {
  ...
  return (0, import_jsx_runtime11.jsxs)(import_jsx_runtime10.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react14.cloneElement)(children, triggerProps), (0, import_jsx_runtime9.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
//# sourceMappingURL=chunk-IIRJT2GW.js.map
